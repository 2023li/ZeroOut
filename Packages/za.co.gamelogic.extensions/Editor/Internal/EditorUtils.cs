...
namespace Gamelogic.Extensions.Editor.Internal
{
	...
	public static class EditorUtils
	{
		...
		public static void DrawNodeCurve(Rect start, Vector3 endPosition)
		{
			...
			var curveColor = EditorGUIUtility.isProSkin ? Color.white : Color.black;
			
			Handles.DrawBezier(startPosition, endPosition, startTangent, endTangent, curveColor, null, 1);

			var oldColor = Handles.color;

			Handles.color = Branding.Coral;
